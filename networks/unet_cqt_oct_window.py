...
class Unet_CQT_oct(nn.Module):
    ...
    def __init__(self, args, device):
        ...
        self.CQTransform=CQT_nsgt(self.args.network.cqt.num_octs, self.args.network.cqt.bins_per_oct, mode="oct",window=(self.args.network.cqt.window, self.args.network.cqt.beta),fs=self.args.exp.sample_rate, audio_len=self.args.exp.audio_len, dtype=torch.float32, device=self.device)
